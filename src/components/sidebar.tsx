...
export default class Sidebar extends Component {
  render() {
    return (
      <div>
        <div>
          <nav ref="#navbar" className="js-colorlib-nav-toggle colorlib-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i /></nav>
